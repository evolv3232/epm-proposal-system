...
import { money, newId, publicBaseUrl } from "../utils/format.js";
import { renderProposalPage } from "../utils/proposalPage.js";

const router = express.Router();

router.get("/health", (req, res) => {
  res.json({ ok: true, version: "1.0.0", proposalRoutesReady: true });
});
...
router.get("/:proposalNumber", (req, res) => {
  const proposal = readCollection("proposals").find(
